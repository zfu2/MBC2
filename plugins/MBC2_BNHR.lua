...
if is_banned(data.id_, arg.chat_id) then
   if not lang then
		...
		tdcli.sendMessage(arg.chat_id, arg.msg_id, 0, "_العضوو_ "..user_name.." *[ "..data.id_.." ]* _تم حظره ✅_", 0, "md")
end
kick_user(data.id_, arg.chat_id)
end
if is_gbanned(data.id_) then
     if not lang then
		...
		tdcli.sendMessage(arg.chat_id, arg.msg_id, 0, "_العضو_ "..user_name.." *[ "..data.id_.." ]* _تم حظره عام ✅_", 0, "md")
   end
kick_user(data.id_, arg.chat_id)
     end
	end
...
if administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
    if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_العضو_ "..user_name.." *"..data.id_.."* * تم بالتأكيد حظره ✅*", 0, "md")
      end
   end
administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] = user_name
   ...
   kick_user(data.id_, arg.chat_id)
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "_العضو_ "..user_name.." *"..data.id_.."* * تم حظره عام ✅*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if not administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "_العضو_ "..user_name.." *"..data.id_.."* * تم بالتأكيد الغاء حظره ✅*", 0, "md")
      end
   end
...
if is_gbanned(data.id_) then
   if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_العضو_ "..user_name.." *"..data.id_.."* * تم بالتأكيد حظره عام ✅*", 0, "md")
      end
   end
...
if not is_gbanned(data.id_) then
   if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_العضو_ "..user_name.." *"..data.id_.."* * تم بالتأكيد الغاء حظره العام ✅*", 0, "md")
      end
   end
  administration['gban_users'][tostring(data.id_)] = nil
    ...
    if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_العضو_ "..user_name.." *"..data.id_.."* * تم الغاء حظره العام ✅*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",

--Begin Tools.lua :)
local SUDO = 60210262 -- حـط ايـديك<===
...
if not is_admin1(data.id_) then
   if not lang then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "* 🕹| User :* "..user_name.."\n *🕹| ID : "..data.id_.."*\n _انه بالتأكيد ليس اداري ✅_", 0, "md")
      end
   end
		table.remove(_config.admins, nameid)
		save_config()
...
return '_🕹 تـم أنـشـاء الـمـجـوعـه ✅_'
   end
end
...
return '_🕹 تـم تـرقـيـه الـمـجـوعـه ✅_'
   end
end
